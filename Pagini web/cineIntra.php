...
$cerere = "INSERT INTO `poarta`.`pontaje` (`ID`, `Data`, `Ora`,`Actiune`) VALUES ('".$_GET['user']."', CURDATE(), CURTIME(),'Deschidere');";
mysql_query($cerere);
...
$cerere = "INSERT INTO `poarta`.`pontaje` (`ID`, `Data`, `Ora`,`Actiune`) VALUES ('".$_GET['user']."', CURDATE(), CURTIME(),'Inchidere');";
mysql_query($cerere);
...
$cerere = "INSERT INTO `poarta`.`pontaje` (`ID`, `Data`, `Ora`,`Actiune`) VALUES ('".$_GET['user']."', CURDATE(), CURTIME(),'Automat');";
mysql_query($cerere);
$output = shell_exec('gpio mode 0 out');
	$output1 = shell_exec('gpio write 0 0');
	sleep(2);
